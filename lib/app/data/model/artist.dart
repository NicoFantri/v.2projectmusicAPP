...
class Artist {
  ...
  // Getter for imageUrl
  String? get imageUrl {
    // Return the URL of the first image or a placeholder
    if (images != null && images!.isNotEmpty) {
      return images![0].url;
    }
    return 'https://via.placeholder.com/150'; // Placeholder if no image is available
  }
  ...
  Artist.fromJson(Map<String, dynamic> json) {
    ...
    followers = json['followers'] != null
        ...
        : null;
    genres = json['genres']?.cast<String>(); // Handle nullable list
    href = json['href'];
    id = json['id'];
    if (json['images'] != null) {
      images = <Images>[];
